...
import az.ailab.lib.messaging.config.annotation.EnableRabbitMessaging;
...
import az.ailab.lib.messaging.infra.proxy.DynamicRabbitProxyFactoryBean;
...
public class RabbitPublisherRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware, BeanFactoryAware {
     ...
     * {@link DynamicRabbitProxyFactoryBean}.
     *
        ...
        try {
            DynamicRabbitProxyFactoryBean<?> factory =
                    new DynamicRabbitProxyFactoryBean<>(
                            ...
                            beanFactory.getBean(EventSerializer.class), // TODO:: should check
