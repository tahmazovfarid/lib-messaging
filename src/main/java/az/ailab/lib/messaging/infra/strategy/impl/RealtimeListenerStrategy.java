...
@Component
public class RealtimeListenerStrategy implements ListenerStrategy {
    ...
    public AbstractContainerListenerAdapter createAdapter(EventProcessingContext ctx,
        ...
        return new RealtimeListenerAdapter(ctx, idem, mapper);
    }

    @Override
    public EventExecutionMode getSupportedMode() {
        return EventExecutionMode.REAL_TIME;
    }
